...
<script>
    ...
    <body>
        ...
        Administrador conduc = (Administrador) session.getAttribute("conductor");
                ...
                out.println("<input type='password' name='password' class='password' placeholder='Contraseña'>");
                out.println("<input type='password' name='password2' class='password' placeholder='Confirmar contraseña'>");
                out.println("<input type='hidden' name='isAd' value='1'>");
                }
                %>
