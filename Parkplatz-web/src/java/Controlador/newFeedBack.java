...
public class newFeedBack extends HttpServlet {
    ...
    private String enviarFeedDos(ParkPlatzWSC.Feedback fed, ParkPlatzWSC.Conductor conductor) throws ClassNotFoundException_Exception {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        ParkPlatzWSC.ParkPlatzWS port = service.getParkPlatzWSPort();
        return port.enviarFeedDos(fed, conductor);
    }
