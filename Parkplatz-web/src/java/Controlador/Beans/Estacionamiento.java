...
public class Estacionamiento extends Persona {
    ...
    public String subirFoto() throws ClassNotFoundException{
        String estado = "";
        Connection con = null;
        try{
            con = Sql.conectar();
            ...
            estado = "Hubo un error a la hora de registrar el archivo en la base";
        }
        return estado;
    }
    ...
    public ArrayList<Estacionamiento> obtenerEstacionamientos() throws ClassNotFoundException{
        ArrayList<Estacionamiento> cualesTengo = new <Estacionamiento>ArrayList();
        try{
            Connection con = Sql.conectar();
